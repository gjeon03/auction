...
if($status_code == 200) {
    ...
    $me_is_post = false; 
    $me_ch = curl_init(); curl_setopt($me_ch, CURLOPT_URL, "https://openapi.naver.com/v1/nid/me"); 
    ...
    $id = $me_responseArr['response']['id']; // 아이디
    $mb_name = $me_responseArr['response']['name']; // 아이디
