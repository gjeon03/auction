...
<div id="section_title" style="font-size:20px">공지하기</div>
<form id="writing_form" action="../section/service_center/notice_insert.php" method="post" enctype="multipart/form-data">
    ...
    <button id="erm" type="submit">공지하기</button> 
</form>